...
if __name__ == '__main__':
    ...
    # data = scio.loadmat('../examples/swarm-2d/data_train.mat')

    # test data
    data = scio.loadmat('../examples/swarm-2d/data_train2.5s_new.mat')
    ...
    c_time = utils.other.get_time_stats(X, time_steps, 0.8)
